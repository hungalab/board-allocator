...
- create a user with your local pc's user id and group id (e.g. the owner of the file added/edited in the container will be the same as when executed on the local pc)
### make runwdisp
- enable X forwarding
